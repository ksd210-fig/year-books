...
export function CameraSetup({ targetYRef, snapCameraRef }: {
  ...
  useFrame(() => {
    ...
    if (snapCameraRef.current) {
      camera.position.set(0, targetYRef.current, 14)
  ...
  return <PerspectiveCamera ref={cameraRef} makeDefault position={[0, 0.5, 14]} fov={30} />
}
