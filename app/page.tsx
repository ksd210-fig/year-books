...
const HAS_LETSLOOK = new Set([
  'year-1000', 'year-1417', 'year-1453', 'year-1492', 'year-1493', 'year-1494',
  'year-1517', 'year-1636', 'year-1789', 'year-1867', 'year-1898', 'year-1913',
  'year-1917', 'year-1918', 'year-1919-paris', 'year-1919-korea', 'year-1927',
  'year-1929-crash', 'year-1929-1939', 'year-1937', 'year-1941', 'year-1945',
  'year-1947', 'year-1962', 'year-1964', 'year-1975', 'year-1991',
])

// 알라딘 spineflip 이미지가 있는 책
const HAS_SPINE = new Set([
  'year-1000', 'year-1417', 'year-1492', 'year-1493', 'year-1517', 'year-1636',
  'year-1789', 'year-1790', 'year-1867', 'year-1898', 'year-1913', 'year-1917',
  'year-1918', 'year-1919-paris', 'year-1919-korea', 'year-1929-crash', 'year-1929-1939',
  'year-1941', 'year-1945', 'year-1947', 'year-1962', 'year-1991',
])

// YearBook → BookItem 변환 (씬에 넘길 데이터)
const SCENE_BOOKS: BookItem[] = BOOKS.map((b, i) => {
  ...
  return {
    ...
    textColor: p.text,
    year: b.year,
    cover: HAS_LETSLOOK.has(b.id) ? `/fronts/${b.id}.jpg` : b.cover,
    back: HAS_LETSLOOK.has(b.id) ? `/backs/${b.id}.jpg` : undefined,
    spine: HAS_SPINE.has(b.id) ? `/spines/${b.id}.jpg` : undefined,
    mmW: b.mmW,
    mmH: b.mmH,
    mmD: b.mmD,
  }
